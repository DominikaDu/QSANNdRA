...
Df, Df_norm = pr.preprocess_training_data(input_directory='data/training_fits/', SN_threshold=7.0, norm_lam = 1290, lam_start=1000, lam_stop=3900)
Df_new = pr.perform_flux_cut(Df=Df, thres_lam=1280)
_, _ = pr.prepare_training_set(input_spectra_file=Df_new,input_norm_file=Df_norm,output_spectra_file='data/dataframes/training_spectra.csv',output_norm_file='data/dataframes/training_spectra_norms.csv',lam_start=1191.5,lam_stop=2900)
Df = []
Df_new = []
Df_norm = []
...
_, _, _, _ = pr.RF_cleanup(spectra_file='data/dataframes/training_spectra.csv',norms_file='data/dataframes/training_spectra_norms.csv',\
