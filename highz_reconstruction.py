...
def prepare_high_z_data(raw_data,z_quasar,skiprows,na_values,norm_lam=1290,lam_start=1191.5,lam_stop=2900,bin_size=10,shuffle=5):
    ...
    [loglam_smooth, flux_smooth] = QSmooth.smooth(loglam,flux,f_err,mask=[],bin_s=bin_size,shuf=shuffle,Lya=False)
...
def plot_smoothed_spectrum(loglam_raw,flux_raw,f_err_raw,loglams,spec,norm,name_plot,name_file):
